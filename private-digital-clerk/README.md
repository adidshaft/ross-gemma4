# Private Digital Clerk

Private Digital Clerk is a privacy-first mobile workbench for Indian advocates. It is designed to keep case files on the device while supporting local OCR, indexing, retrieval, chronology generation, issue extraction, evidence review, draft work product, and optional public-law search through a visible privacy boundary.
