...
let alphaAssistantModelArtifacts: [AlphaCapabilityTier: AlphaAssistantModelArtifact] = [
    ...
    .caseAssociate: AlphaAssistantModelArtifact(
        ...
        quantization: "Q4_K_M",
        downloadURLString: "https://huggingface.co/unsloth/gemma-4-12b-it-GGUF/resolve/main/gemma-4-12b-it-Q4_K_M.gguf",
    ...
    .seniorDraftingSupport: AlphaAssistantModelArtifact(
        ...
        displayName: "Gemma 4 26B-A4B UD Q4_K_M",
        repository: "unsloth/gemma-4-26B-A4B-it-GGUF",
        fileName: "gemma-4-26B-A4B-it-UD-Q4_K_M.gguf",
        quantization: "Q4_K_M",
        downloadURLString: "https://huggingface.co/unsloth/gemma-4-26B-A4B-it-GGUF/resolve/main/gemma-4-26B-A4B-it-UD-Q4_K_M.gguf",
