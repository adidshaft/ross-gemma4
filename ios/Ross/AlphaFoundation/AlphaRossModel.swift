...
let alphaAssistantModelArtifacts: [AlphaCapabilityTier: AlphaAssistantModelArtifact] = [
    .quickStart: AlphaAssistantModelArtifact(
        tier: .quickStart,
        packId: "gemma-3-1b-q4",
        displayName: "Gemma 3 1B Q4_K_M",
        repository: "lmstudio-community/gemma-3-1b-it-GGUF",
        fileName: "gemma-3-1b-it-Q4_K_M.gguf",
        quantization: "Q4_K_M",
        downloadURLString: "https://huggingface.co/lmstudio-community/gemma-3-1b-it-GGUF/resolve/main/gemma-3-1b-it-Q4_K_M.gguf",
        sizeBytes: 814000000,
        sha256: "",
        minimumMemoryGB: 2,
        ...
        sourcePageURLString: "https://huggingface.co/lmstudio-community/gemma-3-1b-it-GGUF",
    ...
    .caseAssociate: AlphaAssistantModelArtifact(
        tier: .caseAssociate,
        packId: "gemma-3-4b-q4",
        displayName: "Gemma 3 4B Q4_K_M",
        repository: "lmstudio-community/gemma-3-4b-it-GGUF",
        fileName: "gemma-3-4b-it-Q4_K_M.gguf",
        quantization: "Q4_K_M",
        downloadURLString: "https://huggingface.co/lmstudio-community/gemma-3-4b-it-GGUF/resolve/main/gemma-3-4b-it-Q4_K_M.gguf",
        ...
        sourcePageURLString: "https://huggingface.co/lmstudio-community/gemma-3-4b-it-GGUF",
        downloadSource: "huggingface",
        verified: true,
        releaseReady: true,
        licenseNotice: "Gemma License",
    ...
    .seniorDraftingSupport: AlphaAssistantModelArtifact(
        ...
        packId: "gemma-3-27b-q4",
        displayName: "Gemma 3 27B Q4_K_M",
        repository: "lmstudio-community/gemma-3-27b-it-GGUF",
        fileName: "gemma-3-27b-it-Q4_K_M.gguf",
        quantization: "Q4_K_M",
        downloadURLString: "https://huggingface.co/lmstudio-community/gemma-3-27b-it-GGUF/resolve/main/gemma-3-27b-it-Q4_K_M.gguf",
        ...
        sourcePageURLString: "https://huggingface.co/lmstudio-community/gemma-3-27b-it-GGUF",
        downloadSource: "huggingface",
        verified: true,
        releaseReady: true,
        licenseNotice: "Gemma License",
