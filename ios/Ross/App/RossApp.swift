...
func rossLocalized(_ key: String, languageCode: String = rossSelectedLanguageCode()) -> String {
    ...
    let table: [String: [String: String]] = [
        ...
        "file_review_focused_source_sections_warning": [
            ...
            "bn": "Local review-এর সময় Ross %2$dটির মধ্যে %1$dটি source section-এ focus করেছে। আরও গভীর review-এর জন্য file ভাগ করুন বা stronger assistant ব্যবহার করুন।",
            "ta": "Local review போது Ross %2$d source section-களில் %1$d பகுதிகளில் focus செய்தது. இன்னும் ஆழமான review-க்கு file-ஐ பிரிக்கவும் அல்லது stronger assistant பயன்படுத்தவும்.",
            "te": "Local review సమయంలో Ross %2$d source sectionల్లో %1$d భాగాలపై focus చేసింది. ఇంకా లోతైన review కోసం file ను విభజించండి లేదా stronger assistant ఉపయోగించండి."
        ],
        ...
        "runtime_first_response": [
            "en": "First response",
            "hi": "First response देखें",
            "bn": "First response দেখুন",
            "ta": "First response பார்க்கவும்",
            "te": "First response చూడండి"
        ],
        "runtime_output_speed": [
            "en": "Output speed",
            "hi": "Output speed देखें",
            "bn": "Output speed দেখুন",
        ...
        "private_assistant_device_comparison_saved_captured_at_label": [
            ...
            "hi": "Saved note captured",
            "bn": "Saved note captured",
        ...
        "private_assistant_device_comparison_saved_device_state_label": [
            "en": "Saved device state",
            "hi": "Saved device state",
            "bn": "Saved device state",
