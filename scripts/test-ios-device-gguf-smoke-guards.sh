...
ROSS_LOCAL_MODEL_SMOKE_PASS runtime=gemma_local_runtime requested_runtime=gemma_local_runtime tier=quick_start profile=full elapsed=10.00s source_refs=1 source_native_model=true general_native_model=true bengali_source_refs=1 bengali_native_model=true hindi_source_refs=1 hindi_native_model=true tamil_source_refs=1 tamil_native_model=true telugu_source_refs=1 telugu_native_model=true
EOF
    ;;
  *)
