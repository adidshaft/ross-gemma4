...
## Architecture
- **Mobile-first inference:** Runs locally on iOS utilizing llama.cpp through Swift integrations.
...
## Submission Details
- **Demo Mode:** Since Gemma 4 GGUFs are currently unreleased placeholders, the app is running in Demo Mode where model responses are simulated for walkthrough purposes. It will gracefully upgrade to real Gemma 4 inference when the verified artifact URLs are updated.
