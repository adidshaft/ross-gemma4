...
export const DEV_MODEL_PACKS: ModelPack[] = [
  {
    ...
    technicalModels: ["gemma4-e4b-q4_k_m-gguf", "embeddinggemma-300m-litert"],
    technicalModelName: "Gemma 4 E4B Q4_K_M",
  ...
  },
  {
    ...
    sizeBytes: 41_287,
    segmentSizeBytes: 8_192,
    technicalModels: ["gemma4-12b-q4_k_m-gguf", "embeddinggemma-300m-litert"],
    technicalModelName: "Gemma 4 12B Q4_K_M",
    repo: "ggml-org/gemma-4-12B-it-GGUF",
    alternateRepo: "bartowski/gemma-4-12B-it-GGUF",
    quantization: "Q4",
  ...
  },
  {
    ...
    sizeBytes: 58_633,
    segmentSizeBytes: 8_192,
    technicalModels: ["gemma4-26b-a4b-q4_k_m-gguf", "embeddinggemma-300m-litert"],
...
export const PRODUCTION_METADATA_MODEL_PACKS: ModelPack[] = [
  {
    ...
    userFacingRole: "Balanced local assistant for short case Q&A, intake review, and lighter matter work",
    technicalRole: "short source-backed Ask Ross answers, lighter summaries, and quick matter review",
    artifactSeed: "gemma4-e4b-basic-metadata-v2",
    ...
    finalSha256: "51865750adafd22de56994a343d5a887cc1a589b9bae41d62b748c8bd0ca9c76",
    verified: true,
    releaseReady: true,
    downloadSource: "huggingface",
    licenseNotice: "Gemma License",
  ...
  },
  {
    ...
    userFacingRole: "Recommended private assistant for richer matter review, larger files, and longer answers",
    technicalRole: "default higher-quality legal assistant, deeper matter reasoning, and longer source-backed Ask Ross",
    artifactSeed: "gemma4-12b-standard-metadata-v1",
    artifactKind: "local_model_artifact",
    runtimeMode: "gemma_local_runtime",
    developmentOnly: false,
    minimumAppVersion: null,
    ...
    finalSha256: "1278394b693672ac2799eadc9a83fd98259a6a88a40acfb1dcaa6c6fc895a606",
    verified: true,
    releaseReady: true,
    downloadSource: "huggingface",
    licenseNotice: "Gemma License",
  ...
  },
  {
    ...
    downloadUrl: "https://huggingface.co/bartowski/google_gemma-4-26B-A4B-it-GGUF/resolve/main/google_gemma-4-26B-A4B-it-Q4_K_M.gguf",
    finalSha256: "e718536fe9b4bd505b07d44ded8f1595053a5d5407315bccf555ce592f33c140",
    verified: true,
    releaseReady: true,
    downloadSource: "huggingface",
    licenseNotice: "Gemma License",
