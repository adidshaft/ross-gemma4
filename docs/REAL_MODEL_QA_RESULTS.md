...
- Observed behavior:
  ...
  - New `mtp_quick` runs now use a smoke-only `2048` context cap with `256` prompt batch and `128` physical batch for the main model; the historical lines above came from the previous `4096` context cap.
